...
- **Sporadic spoon events — the truth of spoonie life.** Beyond the variable daily roll, random **morning shifts** and **mid-day events** nudge your spoons up or down ("a flare met you before your feet hit the floor"; "a second wind, out of nowhere"). Never framed as failure; dips carry a small mercy, and lifts slightly outweigh dips so it stays gentle.
...
- **Full Spoonie Mode (optional).** Switch it on and you can begin only **one in-game day per real day** — you genuinely can't push ahead, the way a body makes you wait. The design philosophy made literal. Fully opt-in, toggle on or off whenever you need; the day boundary is your local midnight, and an in-progress day can always be resumed.
